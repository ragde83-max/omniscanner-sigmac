...
if st.session_state.analisis_completado:
    ...
    with col2: st.download_button("📥 Descargar Reporte Técnico", data=st.session_state.pdf_tecnico, file_name=f"Tecnico_{st.session_state.objetivo_nombre}.pdf", mime="application/pdf", use_container_width=True)import streamlit as st
import xml.etree.ElementTree as ET
import matplotlib.pyplot as plt
import numpy as np
